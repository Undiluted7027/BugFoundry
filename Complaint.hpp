...
class Complaint {
   ...
   public:
      ...
      Complaint& operator=(
         const Complaint& other  // in: Other complaint object to assign from
      );
      ...
      bool operator==(
         const Complaint& other  // in: Other complaint object to compare to
      ) const;
      ...
      void DisplayDetails(
         std::ostream& out  // in: ostream object to handle calling with << operator
      ) const;
